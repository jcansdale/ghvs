    ...
    public class InstalledVersionUtilities
    {
        ...
        public static IEnumerable<ISetupInstance2> GetSetupInstances()
        {
            ...
            catch (COMException e)
            {
                unchecked
                {
                    // Return no insances when VS 2017 or later isn't installed.
        ...
        {
            var path = string.Format($"{Software}\\Microsoft\\VisualStudio\\{majorVersion}.0\\Setup\\VS");
        ...
        private static string Software =>
            IntPtr.Size < 8 ? "SOFTWARE" : "SOFTWARE\\WOW6432Node";
    }
}